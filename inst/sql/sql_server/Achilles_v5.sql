...
select analysis_id, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
from #tempResults
;
...
select analysis_id, stratum_1, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
from #tempResults
;
...
insert into @results_database_schema.ACHILLES_results_dist (analysis_id, stratum_1, count_value, min_value, max_value, avg_value, stdev_value, median_value, p10_value, p25_value, p75_value, p90_value)
select analysis_id, gender_concept_id, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
FROM #tempResults
;
...
insert into @results_database_schema.ACHILLES_results_dist (analysis_id, stratum_1, count_value, min_value, max_value, avg_value, stdev_value, median_value, p10_value, p25_value, p75_value, p90_value)
select analysis_id, age_decile, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
FROM #tempResults
;
...
select analysis_id, stratum1_id, stratum2_id, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
from #tempResults
;
...
insert into @results_database_schema.ACHILLES_results_dist (analysis_id, stratum_1, count_value, min_value, max_value, avg_value, stdev_value, median_value, p10_value, p25_value, p75_value, p90_value)
select analysis_id, stratum_id, count_value, min_value+0, max_value+0, avg_value+0, stdev_value+0, median_value+0, p10_value+0, p25_value+0, p75_value+0, p90_value+0
from #tempResults
;
